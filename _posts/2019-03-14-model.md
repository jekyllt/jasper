...
참고 
------
1. syntax: [장고 모델](https://tutorial.djangogirls.org/ko/django_models/)
2. syntax: [lotto - model class 만들기](https://new93helloworld.tistory.com/283)
3. syntax: [MODEL 클래스 만들기, admin site 에 Model 등록](https://wayhome25.github.io/django/2017/02/28/django-03-lotto-project-3/)
4. syntax: [Django 모델 (Model)](http://pythonstudy.xyz/python/article/308-Django-%EB%AA%A8%EB%8D%B8-Model)
------
